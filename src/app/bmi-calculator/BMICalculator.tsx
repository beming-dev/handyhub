...
const BMICalculatorClient: React.FC = () => {
  // 언어 상태
  ...
  const getBMICategory = (bmi: number) => {
    if (bmi < 18.5) return t.categoryUnderweight; // 저체중
    if (bmi < 25) return t.categoryNormal; // 정상
    if (bmi < 30) return t.categoryOverweight; // 과체중
